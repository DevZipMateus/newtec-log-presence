  ...
  return (
    <section id="contact" className="py-20 bg-secondary">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-background rounded-2xl p-8 md:p-12 text-center max-w-3xl mx-auto shadow-lg">
          <h3 className="text-3xl font-bold mb-4">Fale conosco pelo WhatsApp</h3>
