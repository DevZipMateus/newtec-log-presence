  ...
  return (
    <section id="contact" className="py-12 sm:py-16 lg:py-20 bg-secondary">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Card key={index} className="border-none shadow-md">
              <CardContent className="p-4 sm:p-5 lg:p-6">
                <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-primary/10 rounded-lg flex items-center justify-center mb-2 sm:mb-3 lg:mb-4">
                  <info.icon className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-primary" />
                </div>
                <h3 className="font-bold mb-1.5 sm:mb-2 text-xs sm:text-sm lg:text-base">{info.title}</h3>
        ...
        <div className="bg-background rounded-xl sm:rounded-2xl p-5 sm:p-6 lg:p-8 xl:p-12 text-center max-w-3xl mx-auto shadow-lg">
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-2 sm:mb-3 lg:mb-4">Fale conosco pelo WhatsApp</h3>
          ...
          <Button
            size="lg"
            className="text-sm sm:text-base lg:text-lg w-full sm:w-auto px-6 sm:px-8"
            asChild
          >
            <a
        ...
        <div className="mt-6 sm:mt-8 lg:mt-12 rounded-xl sm:rounded-2xl overflow-hidden shadow-lg">
          <iframe
